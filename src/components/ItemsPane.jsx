...
export function ItemsPanel({ items, updateItems, showToast, onTrash }) {
                ...
                <table className="w-full border-collapse text-[12.5px] min-w-[560px]">
                  <thead>
                    <tr className="bg-[#F1EDE3] text-left sticky top-0">
                      {["", "Category", "Code", "Description", "Supplier", "Unit", "Stock", "Cost", "Rate", "Margin", ""].map((h, i) => (
                        <th key={i} className="font-mono text-[10.5px] tracking-[0.06em] uppercase text-[#8A8574] font-semibold px-3.5 py-...">
                          {h}
                        </th>
                      ))}
                    </tr>
